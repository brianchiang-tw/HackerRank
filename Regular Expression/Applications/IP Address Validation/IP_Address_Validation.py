...
regex_ipv4 = r'^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$'
...
pattern_ipv6 = re.compile(regex_ipv6)


def validate_ipv4(s):

    result = re.match( pattern_ipv4, s )
...
def validate_ipv6(s):
    ...
    result = re.match( pattern_ipv6, s )
...
if __name__ == '__main__':
    ...
    for _ in range(n):
        ...
        if validate_ipv4(input_str):
            print("IPv4")
        
        elif validate_ipv6(input_str):
            print("IPv6")
